...
echo "pl 0,10,100 0,1,0 255,255,255"
echo "pl 0,-10,100 0,1,0 0,255,255"
for i in `seq 1 20`;do
    ...
    echo "co $(($RANDOM % 20 - 10)),$(($RANDOM % 20 - 10)),$(($RANDOM % 25)) $(($RANDOM % 3 - 1)),$(($RANDOM % 3 - 1)),$(($RANDOM % 3 - 1)) 1.0 2.0 $(($RANDOM % 256)),$(($RANDOM % 256)),$(($RANDOM % 256))"
done